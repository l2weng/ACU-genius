...
http.listen(port, function () {
  let bonjourService = bonjour.publish({ name: 'LabelReal Server', type: 'http', port: port })
  ...
  bonjourService.on('down', function () {
    console.log(bonjourService)
    if (!workers[bonjourService.host]) return
    delete workers[bonjourService.host]
  })
